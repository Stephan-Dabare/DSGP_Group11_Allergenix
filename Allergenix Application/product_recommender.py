...
def predict_category(input_embedding, model_path="model/component_4_models/new_random_forest.pkl"):
    """
...
def get_recommendation(input_embedding, primary_category=None, selected_tertiary=None,
                       concern_chems_include=[], the_gens_include=[], red_list_include=[],
                       data=None, model_path="model/component_4_models/new_random_forest.pkl"):
    """
